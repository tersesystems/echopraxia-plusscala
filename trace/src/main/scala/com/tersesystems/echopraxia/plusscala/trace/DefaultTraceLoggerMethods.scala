...
trait DefaultTraceLoggerMethods[FB <: TracingFieldBuilder] extends DefaultMethodsSupport[FB] with TraceLoggerMethods[FB] {
  ...
  @inline
  private def entering(implicit line: Line, file: File, fullname: FullName, enc: Enclosing, args: Args): Function[FB, FieldBuilderResult] = {
    fb: FB =>
      fb.entering
  }.asJava
  ...
  private def exiting[B: ToValue](
      ret: B
  )(implicit line: Line, file: File, fullname: FullName, enc: Enclosing, args: Args): Function[FB, FieldBuilderResult] = { fb: FB =>
  ...
  @inline
  private def execute[B: ToValue](level: JLevel, attempt: => B)(implicit line: Line, file: File, fullname: FullName, enc: Enclosing, args: Args) = {
